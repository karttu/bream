...
;; This file contains still a bunch of both tested (more or less) and 
;; totally untested functions.
;;
;; Written Aug-Sep 2010 by Antti Karttunen and placed in Public Domain.
;;
(-MODULE-INFO-END-)
;;
;; Started writing this file Aug 25 2010.
;; Contains definitions of some of the most basic arithmetic functions needed,
;; like quotient, remainder, integer-divide, gcd, lcm.
;; Then contains a lot's of integer seq. functions (those Axxxxxx)
;; which are either often useful, or can be used for building
;; test suites. Should be separated to a file of their own.
;;
;; Thinking also about staged forms, utilizing recursive macros
;; or such.
;;
...
(define (A000010_naive_par_aux n start_offset increment)
  (let loop ((prev_i start_offset) (i start_offset) (s (zeqw n)))
