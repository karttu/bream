...
// `define UART_BPS_RATE_DIVIDER 12'd54 // For ATLYS running on 100MHz.

// For 50MHz clock we need half smaller divider:
`define UART_BPS_RATE_DIVIDER 12'd27 // For Spartan-3 running on 50MHz.
